...
def init_state_values(**values):
    ...
    init_values = np.array([-4.51134525104e-06, 1.85,
        0.0147730085064, 0.130660965615, 0.99999783454, 1.81017564384e-06,\
        3.049496488e-07, 3.41212828972e-08, 0.00700005394874],\
        dtype=np.float_)

    # State indices and limit checker
    state_ind = dict([("intf",(0, Range())), ("SL",(1, Range())),\
        ("TRPNCaL",(2, Range())), ("TRPNCaH",(3, Range())), ("N",(4,\
        Range())), ("XBpostr",(5, Range())), ("XBprer",(6, Range())),\
        ("xXBprer",(7, Range())), ("xXBpostr",(8, Range()))])
...
def init_parameter_values(**values):
    ...
    init_values = np.array([6.25, 2.5, 6.25, 6.25, 6.25, 0.5, 0.07, 6, 0.07,\
        0.4, 0, 2, 5, 1, 8, 1, 0.002, 2.4, 1.4, 1.85, 1.85, 0, 50.0, 120,\
        0.003, 1.45, 0.09, 5, 20, 110, 24, 0.1, 1.65, 1.2, 0.007, 1.6, 1.3,\
        1.5, 1.6, 0.5, 0.025, 0.25, 1, 0.05, 0.05, 15, 0.5, 2, 70, 120, 1.0],\
        dtype=np.float_)
    ...
    param_ind = dict([("Qfapp", (0, Range())), ("Qgapp", (1, Range())),\
        ...
        (15, Range())), ("Cp", (16, Range())), ("SLmax", (17, Range())),\
        ("SLmin", (18, Range())), ("SLrest", (19, Range())), ("SLset", (20,\
        Range())), ("applied_stretch", (21, Range())), ("b_ff", (22,\
        Range())), ("kxb_normalised", (23, Range())), ("visc", (24,\
        Range())), ("Ca_amplitude", (25, Range())), ("Ca_diastolic", (26,\
        Range())), ("start_time", (27, Range())), ("tau1", (28, Range())),\
        ("tau2", (29, Range())), ("TmpC", (30, Range())), ("len_hbare", (31,\
        Range())), ("len_thick", (32, Range())), ("len_thin", (33, Range())),\
        ("x_0", (34, Range())), ("Qkn_p", (35, Range())), ("Qkoff", (36,\
        Range())), ("Qkon", (37, Range())), ("Qkp_n", (38, Range())),\
        ("kn_p", (39, Range())), ("koffH", (40, Range())), ("koffL", (41,\
        Range())), ("koffmod", (42, Range())), ("kon", (43, Range())),\
        ("kp_n", (44, Range())), ("nperm", (45, Range())), ("perm50", (46,\
        Range())), ("xPsi", (47, Range())), ("Trop_conc", (48, Range())),\
        ("kxb", (49, Range())),("T_ref", (50, Range()))])
...
def parameter_indices(*params):
    ...
    param_inds = dict([("Qfapp", 0), ("Qgapp", 1), ("Qgxb", 2), ("Qhb", 3),\
        ...
        ("sigmap", 14), ("xbmodsp", 15), ("Cp", 16), ("SLmax", 17), ("SLmin",\
        18), ("SLrest", 19), ("SLset", 20), ("applied_stretch", 21), ("b_ff",\
        22), ("kxb_normalised", 23), ("visc", 24), ("Ca_amplitude", 25),\
        ("Ca_diastolic", 26), ("start_time", 27), ("tau1", 28), ("tau2", 29),\
        ("TmpC", 30), ("len_hbare", 31), ("len_thick", 32), ("len_thin", 33),\
        ("x_0", 34), ("Qkn_p", 35), ("Qkoff", 36), ("Qkon", 37), ("Qkp_n",\
        38), ("kn_p", 39), ("koffH", 40), ("koffL", 41), ("koffmod", 42),\
        ("kon", 43), ("kp_n", 44), ("nperm", 45), ("perm50", 46), ("xPsi",\
        47), ("Trop_conc", 48), ("kxb", 49), ("T_ref",50)])
...
def monitor_indices(*monitored):
    ...
    monitor_inds = dict([("fappT", 0), ("gapslmd", 1), ("gappT", 2), ("hfmd",\
        ...
        ("active", 13), ("lmbda", 14), ("passive", 15), ("preload", 16),\
        ("afterload", 17), ("total_force", 18), ("dSL", 19), ("beta", 20),\
        ("Cai", 21), ("konT", 22), ("koffLT", 23), ("koffHT", 24),\
        ("dTRPNCaL", 25), ("dTRPNCaH", 26), ("Tropreg", 27),\
        ("perm50_on_Tropreg", 28), ("permtot", 29), ("inprmt", 30), ("kn_pT",\
        31), ("kp_nT", 32), ("dXBpostr", 33), ("P", 34), ("dXBprer", 35),\
        ("dutyprer", 36), ("dutypostr", 37), ("dxXBprer", 38), ("dxXBpostr",\
        39), ("FrSBXB", 40), ("dFrSBXB", 41), ("dsovr_ze", 42), ("dsovr_cle",\
        43), ("dlen_sovr", 44), ("dSOVFThin", 45), ("dSOVFThick", 46),\
        ("TropTot", 47), ("dTropTot", 48), ("dforce", 49), ("sovr_ze", 50),\
        ("sovr_cle", 51), ("len_sovr", 52), ("SOVFThick", 53), ("SOVFThin",\
        54), ("dintf_dt", 55), ("dSL_dt", 56), ("dTRPNCaL_dt", 57),\
        ("dTRPNCaH_dt", 58), ("dN_dt", 59), ("dXBpostr_dt", 60),\
        ("dXBprer_dt", 61), ("dxXBprer_dt", 62), ("dxXBpostr_dt", 63)])
...
def rhs(states, t, parameters, ca_func, values=None):
    ...
    Qfapp=parameters[0]; Qgapp=parameters[1]; Qgxb=parameters[2];\
        ...
        xbmodsp=parameters[15]; Cp=parameters[16]; SLrest=parameters[19];\
        SLset=parameters[20]; applied_stretch=parameters[21];\
        b_ff=parameters[22]; kxb_normalised=parameters[23];\
        visc=parameters[24]; Ca_amplitude=parameters[25];\
        Ca_diastolic=parameters[26]; start_time=parameters[27];\
        tau1=parameters[28]; tau2=parameters[29]; TmpC=parameters[30];\
        len_hbare=parameters[31]; len_thick=parameters[32];\
        len_thin=parameters[33]; x_0=parameters[34]; Qkn_p=parameters[35];\
        Qkoff=parameters[36]; Qkon=parameters[37]; Qkp_n=parameters[38];\
        kn_p=parameters[39]; koffH=parameters[40]; koffL=parameters[41];\
        koffmod=parameters[42]; kon=parameters[43]; kp_n=parameters[44];\
        nperm=parameters[45]; perm50=parameters[46]; xPsi=parameters[47];\
        T_ref=parameters[50]
...
def monitor(states, t, parameters, monitored=None):
    ...
    Qfapp=parameters[0]; Qgapp=parameters[1]; Qgxb=parameters[2];\
        ...
        koffmod=parameters[42]; kon=parameters[43]; kp_n=parameters[44];\
        nperm=parameters[45]; perm50=parameters[46]; xPsi=parameters[47];\
        Trop_conc=parameters[48]; kxb=parameters[49]; T_ref=parameters[50]

    # Init return args
    if monitored is None:
        monitored = np.zeros((64,), dtype=np.float_)
    else:
        assert isinstance(monitored, np.ndarray) and monitored.shape == (64,)

    # Expressions for the Sarcomere geometry component
    monitored[50] = (len_thick/2 if len_thick/2 < SL/2 else SL/2)
    monitored[51] = (len_thin - SL/2 if len_thin - SL/2 > len_hbare/2 else\
        len_hbare/2)
    monitored[52] = -monitored[51] + monitored[50]
    monitored[53] = overlap_func(SL) #NB modified here 2*monitored[52]/(len_thick - len_hbare)
    ...
    # Expressions for the Equation for simulated calcium transient component
    monitored[20] = math.pow(tau1/tau2, -1/(-1 + tau1/tau2)) -\
        math.pow(tau1/tau2, -1/(1 - tau2/tau1))
    monitored[21] = (Ca_diastolic + (Ca_amplitude -\
        Ca_diastolic)*(-math.exp((start_time - t)/tau2) +\
        math.exp((start_time - t)/tau1))/monitored[20] if t > start_time else\
        Ca_diastolic)
    ...
    monitored[28] = (perm50/monitored[27] if monitored[27] > 0.01 else\
        100*perm50)
    monitored[29] = math.sqrt(math.fabs(1.0/(1 + math.pow(monitored[28],\
        nperm))))
    ...
    monitored[37] = monitored[0]*monitored[5]/(monitored[0]*monitored[5] +\
        monitored[0]*monitored[6] + monitored[0]*monitored[8] +\
        monitored[2]*monitored[6] + monitored[2]*monitored[8] +\
        monitored[5]*monitored[8])
    monitored[38] = monitored[19]/2 + xPsi*((-x_0 - xXBprer +\
        xXBpostr)*monitored[6] - monitored[0]*xXBprer)/monitored[36]
    monitored[39] = monitored[19]/2 + xPsi*(x_0 - xXBpostr +\
        xXBprer)*monitored[5]/monitored[37]
    ...
    monitored[48] = Trop_conc*((1 - monitored[54])*monitored[25] + ((1 -\
        monitored[40])*TRPNCaL + TRPNCaH*monitored[40])*monitored[45] + ((1 -\
        monitored[40])*monitored[25] + TRPNCaH*monitored[41] +\
        monitored[26]*monitored[40] - TRPNCaL*monitored[41])*monitored[54] -\
